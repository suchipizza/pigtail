...
| [2026-09-25-forecasting-test-amendment-2.md](2026-09-25-forecasting-test-amendment-2.md) | Amends the forecasting test (original at `3f07692`, amendment 1 at `2521652`): evaluation set excludes H-sealed (ADR-039.5); superseded in wording by amendment 3 | PRD §9.1 (1), ADR-039 | frozen at the commit that adds it | none |

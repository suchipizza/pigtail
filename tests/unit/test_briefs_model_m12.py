...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda d: d["success"]["minimums"].update(adoption="p80"), "success.minimums.adoption"),
        (lambda d: d["success"]["minimums"].update(attention="at_least_median"),
         "success.minimums.attention"),
